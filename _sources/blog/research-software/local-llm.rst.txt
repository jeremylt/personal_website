...
Additionally, fundamental ethical concerns, such as around training data and environmental costs remain.
See `here <jeremylt.org/blog/research-software/ai-ethics>`_ for my thoughts on the ethics surrounding AI/LLM based software development tools more generally.
...
However, this does make it difficult to prompt the LLM to review generated code, which is one of the usages I am personally more comfortable with.
This usage feels less fraught when compared to using an LLM to plan development or generate code, especially considering the issues around attribution.
Though, as noted above, I do not see local LLMs as an ethical 'get out of jail free' card.
